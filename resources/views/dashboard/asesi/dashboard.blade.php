        ...
        <div class="max-w-7xl mx-auto relative z-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 mb-16">
                ...
                <div class="relative group card-hover">
                    <div class="absolute -inset-1 bg-gradient-to-r from-orange-400 to-orange-500 rounded-3xl blur opacity-20 group-hover:opacity-30">
                    </div>
                    <div class="relative h-[600px] rounded-3xl shadow-2xl overflow-hidden bg-white border border-gray-200">
                        ...
                        <div class="relative h-full flex flex-col justify-between p-8 text-white">
                            <div>
                                <div class="mb-6">
                                    <span class="inline-flex items-center px-4 py-2 bg-white/20 text-gray-700 text-sm font-bold rounded-full glass-effect">
                                        LEVEL A
                                    </span>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <button onclick="document.getElementById('modalA').classList.remove('hidden')" class="bg-white text-orange-500 px-6 py-3 font-bold rounded-xl hover:bg-orange-50 transition-all  shadow-lg">
                                        Detail Program
                                    </button>
                                    @else
                                    <button onclick="document.getElementById('modalA').classList.remove('hidden')" class="bg-white text-orange-500 px-6 py-3 font-bold rounded-xl hover:bg-orange-50 transition-all  shadow-lg">
                ...
                <!-- Level B -->
                <div class="relative group card-hover">
                    <div class="absolute -inset-1 bg-gradient-to-r from-blue-400 to-blue-600 rounded-3xl blur opacity-20 group-hover:opacity-30">
                    </div>
                    <div class="relative h-[600px] rounded-3xl shadow-2xl overflow-hidden bg-white border border-gray-200">
                        ...
                        <div class="relative h-full flex flex-col justify-between p-8 text-white">
                            ...
                            <div>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <button onclick="document.getElementById('modalB').classList.remove('hidden')" class="bg-white text-blue-600 px-6 py-3 font-bold rounded-xl hover:bg-blue-50 transition-all transform hover:scale-105 shadow-lg">
                                        Mulai Sekarang
                                    </button>
                                    @else
                                    <button onclick="document.getElementById('modalB').classList.remove('hidden')" class="bg-white text-blue-600 px-6 py-3 font-bold rounded-xl hover:bg-blue-50 transition-all transform hover:scale-105 shadow-lg">
                ...
                <!-- Level C -->
                <div class="relative group card-hover">
                    <div class="absolute -inset-1 bg-gradient-to-r from-blue-500 to-blue-700 rounded-3xl blur opacity-20 group-hover:opacity-30">
                    </div>
                    <div class="relative h-[600px] rounded-3xl shadow-2xl overflow-hidden bg-white border border-gray-200">
                        ...
                        <div class="relative h-full flex flex-col justify-between p-8 text-white">
                            ...
                            <div>
                                ...
                                <div class="flex items-center justify-between">
                                    <button onclick="document.getElementById('modalC').classList.remove('hidden')" class="bg-white text-blue-700 px-6 py-3 font-bold rounded-xl hover:bg-blue-50 transition-all transform hover:scale-105 shadow-lg">
                                        Detail Program
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="relative h-[600px] rounded-3xl shadow-2xl overflow-hidden bg-white border border-gray-200">
                        ...
                        <div class="relative h-full flex flex-col justify-between p-8 text-white">
                            ...
                            <div>
                                ...
                                <div class="flex items-center justify-between">
                                    <button onclick="document.getElementById('modalBUNDLING').classList.remove('hidden')" class="bg-white text-blue-700 px-6 py-3 font-bold rounded-xl hover:bg-blue-50 transition-all transform hover:scale-105 shadow-lg">
                                        Detail Program
                                    </button>
                                </div>
                            </div>
