            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
                <div class="relative">
                    <div class="flex items-center gap-3 mb-1">
                        <h2 class="text-3xl font-extrabold text-slate-700 tracking-tight">Profil Saya</h2>
                    </div>
                    <p class="text-slate-500 font-medium">Kelola informasi identitas dan keamanan akun Anda</p>
                </div>

                <div class="mt-2 md:mt-0">
                    <div
                        class="group flex items-center bg-white border border-slate-200 rounded-2xl px-5 py-2.5 shadow-sm hover:shadow-md transition-all duration-300">
                        <div class="relative flex mr-3">
                            <span
                                class="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
                            <span
                                class="relative inline-flex rounded-full h-3 w-3 bg-green-500 border-2 border-white"></span>
                        </div>
                        <div class="flex flex-col">
                            <span
                                class="text-[10px] uppercase tracking-wider font-bold text-slate-400 leading-none mb-1">Account
                                Status</span>
                            <span class="text-sm font-bold text-slate-700 leading-none uppercase">Aktif</span>
                        </div>
                    </div>
                </div>
            </div>
