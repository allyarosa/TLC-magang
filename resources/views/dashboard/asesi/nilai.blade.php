                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead class="bg-gradient-to-r from-blue-50 to-orange-50">
                            <tr>
                                <th class="px-8 py-5 text-left text-xs font-bold text-[#1D4E89] uppercase tracking-wider">No
                                </th>
                        ...
                        <tbody class="bg-white divide-y divide-orange-100">
                            @forelse ($exams as $data)
                                <tr class="table-row">
                                    ...
                                    <td class="px-8 py-6">
                                        <span
                                            class="px-3 py-1 text-xs font-semibold bg-gray-100 text-gray-800 rounded-full">
                                            {{ $data->unanswered_questions ?? 0 }}
                                        </span>
                                    </td>
                                    <td class="px-8 py-6">
                                        <span
                                            class="px-3 py-1 text-xs font-semibold bg-teal-100 text-teal-800 rounded-full">
                                            {{ $data->correct_answers ?? 0 }}
                                        </span>
                                    </td>
                                    <td class="px-8 py-6">
                                        <span
                                            class="px-3 py-1 text-xs font-semibold bg-pink-100 text-pink-800 rounded-full">
