    ...
    <div class="bg-gray-50 rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="p-3 sm:p-4 lg:p-6">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
                    <div class="rounded-full h-12 w-12 sm:h-16 sm:w-16 overflow-hidden flex-shrink-0 mx-auto sm:mx-0">
                        <img src="{{ $userProfile && $userProfile->profile_image
                                ...
                                : asset('/storage/blankprofile.png') }}" alt="Foto Profil" class="object-cover h-full w-full">
            ...
            <div class="mb-4 sm:mb-5 lg:mb-6">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center text-yellow-600 mb-2">
                    <div class="flex items-center mb-1 sm:mb-0">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 mr-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    @if ($asesi->modul_ajar)
                    <a href="{{ asset('storage/' . $asesi->modul_ajar) }}" target="_blank" class="text-sm sm:text-base sm:ml-1 text-blue-600 underline hover:text-blue-800 transition">
                        Lihat File
                    </a>
                    @else
            ...
            <form action="{{ route('asesor.gradeB.store', Vinkla\Hashids\Facades\Hashids::encode($asesi->id)) }}" method="POST">
                @csrf
                ...
                <div class="mb-4 sm:mb-5 lg:mb-6">
                    ...
                    <div class="space-y-2 sm:space-y-3">
                        <div class="flex items-center">
                            <input id="kompeten" name="assessment" type="radio" value="passed" @checked(old('assessment', $asesi->is_passed) === 'passed')
                            class="h-4 w-4 text-blue-800 focus:ring-blue-800 focus:ring-2">
                            <label for="kompeten" class="ml-2 sm:ml-3 block text-gray-700 text-sm sm:text-base cursor-pointer">Kompeten</label>
                        </div>
                        <div class="flex items-center">
                            <input id="belum-kompeten" name="assessment" type="radio" value="rejected" @checked(old('assessment', $asesi->is_passed) === 'rejected')
                            class="h-4 w-4 text-blue-800 focus:ring-blue-800 focus:ring-2">
                            <label for="belum-kompeten" class="ml-2 sm:ml-3 block text-gray-700 text-sm sm:text-base cursor-pointer">Belum
                                Kompeten</label>
                        </div>
                ...
                <div class="mb-4 sm:mb-5 lg:mb-6">
                    ...
                    <div class="relative">
                        <select name="score" required class="block w-full bg-white border border-gray-300 text-gray-700 py-2 sm:py-3 px-3 sm:px-4 pr-8 rounded-lg sm:rounded-full leading-tight focus:outline-none focus:border-blue-800 text-sm sm:text-base">
                ...
                <div class="mb-4 sm:mb-8">
                    <label for="description" class="block text-gray-700 mb-2 text-sm sm:text-base font-medium">
                        Komentar</label>
                    <textarea name="comment_asesor" id="editor" rows="2" class="w-full border border-gray-300 rounded-lg px-3 sm:px-4 py-2 sm:py-3 text-gray-700 focus:outline-none focus:border-blue-800 focus:ring-1 focus:ring-blue-800 text-sm sm:text-base resize-y min-h-[100px]">
                ...
                <div class="flex flex-col sm:flex-row justify-between gap-3 sm:gap-4 mt-6 sm:mt-8">
                    <div>
                        <a href="{{ route('asesor.list-asesi') }}" class="w-full sm:w-auto order-2 sm:order-1 border border-gray-300 text-gray-700 rounded-lg px-4 sm:px-5 py-2 sm:py-3 hover:bg-gray-100 transition duration-200 text-sm sm:text-base font-medium">
                            Kembali
                        </a>
                        <button class="w-full sm:w-auto order-2 sm:order-1 border border-gray-300 text-gray-700 rounded-lg px-4 sm:px-5 py-2 sm:py-3 hover:bg-gray-100 transition duration-200 text-sm sm:text-base font-medium">
                            Simpan Draft
                        </button>
                    </div>

                    <button class="w-full sm:w-auto order-1 sm:order-2 bg-blue-800 text-white rounded-lg px-4 sm:px-5 py-2 sm:py-3 hover:bg-blue-700 transition duration-200 text-sm sm:text-base font-medium">
                        Kirim Penilaian
                    </button>
                </div>
            </form>
