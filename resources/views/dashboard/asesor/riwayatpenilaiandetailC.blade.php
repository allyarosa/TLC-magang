...
@section('title', 'Detail Riwayat Penilaian Level C')
@section('content')
                ...
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6 mr-2 flex-shrink-0" fill="none"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 112-2h2a2 2 0 112 2" />
                    </svg>
                    <div>
                        <h2 class="text-lg sm:text-xl lg:text-2xl font-bold">Detail Riwayat Penilaian Asesi Level C</h2>
                    </div>
                </div>
            </div>
                    ...
                    @if ($detail->category != 'essay')
                        <div class="flex flex-col sm:flex-row sm:items-center text-yellow-600 mb-2">
                            <div class="flex items-center mb-1 sm:mb-0">
                                ...
                                <h3 class="font-bold text-sm sm:text-base">URL Video: </h3>
                            </div>
                            @if ($detail->url_video)
                                <a href="{{ $detail->url_video }}" target="_blank"
                                    class="text-sm sm:text-base sm:ml-1 text-blue-600 underline hover:text-blue-800 transition">
                                    Lihat Video
                                </a>
                            @else
                                <span class="text-sm sm:text-base sm:ml-1 text-red-600">Tidak ada URL Video</span>
                            @endif
                        </div>
                    @endif
