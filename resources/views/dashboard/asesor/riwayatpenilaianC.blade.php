    ...
    <div class="bg-white mt-6 rounded-lg shadow-md overflow-hidden">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center p-4 lg:p-6 gap-4" style="background-color: #F8C82A;">
            <div class="flex items-center text-gray-800">
                <svg class="w-6 h-6 text-gray-800 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-2 lg:ml-auto">
                <form action="{{ route('asesor.riwayat-penilaian-c') }}" method="GET" class="relative">
                ...
                <div class="flex space-x-2">
                    ...
                    <a href="{{ route('asesor.riwayat-penilaian-c.export') }}" class="flex-1 sm:flex-none px-4 py-2 bg-blue-800 border border-blue-900 rounded-lg text-white font-medium hover:bg-blue-700 flex items-center justify-center text-sm">
            ...
            <table class="min-w-full">
                <thead>
                    <tr class="border-b border-gray-200" style="background-color: #00549D;">
                        ...
                        <th class="py-4 px-6 text-right text-white font-medium text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-blue-50">
                        ...
                        <td class="py-4 px-6 text-sm">
                            <span class="px-3 py-1 @if($item->is_passed == 'passed') bg-green-500 @elseif($item->is_passed == 'rejected') bg-red-500 @else bg-yellow-500 @endif text-white rounded-full text-xs font-medium">{{ Str::ucfirst($item->is_passed) }}</span>
                        </td>
                        <td class="py-3 px-6 text-right">
                            <div class="flex items-center justify-start">
                                <a href="{{ route('asesor.riwayat-penilaian-c-detail', Vinkla\Hashids\Facades\Hashids::encode($item->id)) }}" class="text-blue-800 hover:text-blue-600">
