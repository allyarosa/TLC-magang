        ...
        <div class="flex flex-col lg:flex-row lg:items-center p-4 lg:p-6 gap-4" style="background-color: #F8C82A;">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-2 lg:ml-auto">
                ...
                <div class="flex space-x-2">
                    ...
                    <a href="{{ route('asesor.riwayat-penilaian-b.export') }}" class="flex-1 sm:flex-none px-4 py-2 bg-blue-800 border border-blue-900 rounded-lg text-white font-medium hover:bg-blue-700 flex items-center justify-center text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-blue-50">
                        ...
                        <td class="py-4 px-6 text-sm">
                            <span class="px-3 py-1 bg-yellow-500 text-white rounded-full text-xs font-medium">{{ $item->is_passed }}</span>
                        </td>
                        <td class="py-3 px-6 text-right">
                            <div class="flex items-center justify-start">
                                <a href="{{ route('asesor.riwayat-penilaian-detail', Vinkla\Hashids\Facades\Hashids::encode($item->id)) }}" class="text-blue-800 hover:text-blue-600">
