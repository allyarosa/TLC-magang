        ...
        <div class="bg-white rounded-lg shadow-md p-3 sm:p-4 lg:p-6 mb-4 sm:mb-6">
            ...
            <div class="flex flex-col space-y-3 sm:space-y-4 lg:flex-row lg:justify-between lg:space-y-0 mb-4 sm:mb-6">
                ...
                <div class="relative w-full lg:w-auto">
                    <form method="GET" action="{{ route('asesor.list-asesi-c') }}"
                ...
                <!-- Filters (if needed for Level C, currently simplified) -->
                    ...
                    <div class="relative">
                        <form method="GET" action="{{ route('asesor.list-asesi-c') }}" class="mb-4">
                            <select name="kategori" onchange="this.form.submit()"
                                ...
                                <option value="essay" {{ request('kategori') === 'essay' ? 'selected' : '' }}>Esai</option>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($levelC as $index)
                            <tr class="hover:bg-blue-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-700">
                                        {{ $index->questionC->title ?? 'N/A' }} {{-- Assuming relation to QuestionC --}}
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @php
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm flex justify-end">
                                    @if ($index->status === 'pending')
                                        <a href="{{ route('asesor.gradeC.asesi', Hashids::encode($index->id)) }}"
                        ...
                        <div class="flex flex-col space-y-3">
                            ...
                            <div class="flex justify-between items-center pt-2 border-t border-gray-100">
                                ...
                                <div class="flex space-x-2">
                                    ...
                                    @else
                                        <a href="{{ route('asesor.gradeC.asesi', Hashids::encode($index->id)) }}"
                                            class="bg-green-600 hover:bg-green-500 text-white px-3 py-1.5 rounded-lg text-xs transition duration-200">
                                            Lihat Detail
                                        </a>
                                    @endif
                                </div>
