    ...
    <div class="bg-white rounded-lg shadow-md p-3 sm:p-4 lg:p-6 mb-4 sm:mb-6">
        ...
        <div class="flex flex-col space-y-3 sm:space-y-4 lg:flex-row lg:justify-between lg:space-y-0 mb-4 sm:mb-6">
            ...
            <div class="relative w-full lg:w-auto">
                <form method="GET" action="{{ route('asesor.list-asesi') }}" class="flex flex-col sm:flex-row gap-2 sm:items-center mb-4">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-blue-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm flex justify-end">
                            @if ($index->score)
                            <a href="{{ route('asesor.gradeB.show', Vinkla\Hashids\Facades\Hashids::encode($index->id)) }}" class="bg-green-600 hover:bg-green-500 text-white px-3 py-1 rounded-lg flex items-center gap-1 shadow-md font-semibold">
                            ...
                            @else
                            <a href="{{ route('asesor.gradeB.asesi', Vinkla\Hashids\Facades\Hashids::encode($index->id)) }}" class="bg-red-500 hover:bg-red-400 text-white px-3 py-1 rounded-lg flex items-center gap-1 border border-red-600 font-semibold">
                                Belum Dinilai
                            </a>
                            @endif
