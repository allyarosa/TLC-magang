...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-4">
        ...
        {{-- Total Asesi --}}
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 flex flex-col gap-3 group hover:shadow-md transition-all duration-300 relative overflow-hidden">
            <div class="w-10 h-10 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-300">
            ...
            <div class="absolute -bottom-4 -right-4 w-16 h-16 bg-blue-50 rounded-full opacity-40 group-hover:scale-125 transition-transform duration-500"></div>
        </div>

        {{-- Total Asesor --}}
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 flex flex-col gap-3 group hover:shadow-md transition-all duration-300 relative overflow-hidden">
            <div class="w-10 h-10 bg-orange-50 rounded-xl flex items-center justify-center text-orange-600 group-hover:bg-orange-500 group-hover:text-white transition-colors duration-300">
            ...
            <div class="absolute -bottom-4 -right-4 w-16 h-16 bg-orange-50 rounded-full opacity-40 group-hover:scale-125 transition-transform duration-500"></div>
        </div>

        {{-- Total Admin --}}
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 flex flex-col gap-3 group hover:shadow-md transition-all duration-300 relative overflow-hidden">
            <div class="w-10 h-10 bg-indigo-50 rounded-xl flex items-center justify-center text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white transition-colors duration-300">
            ...
            <div class="absolute -bottom-4 -right-4 w-16 h-16 bg-indigo-50 rounded-full opacity-40 group-hover:scale-125 transition-transform duration-500"></div>
        </div>

        {{-- Total Revenue --}}
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 flex flex-col gap-3 group hover:shadow-md transition-all duration-300 relative overflow-hidden">
            <div class="w-10 h-10 bg-emerald-50 rounded-xl flex items-center justify-center text-emerald-600 group-hover:bg-emerald-600 group-hover:text-white transition-colors duration-300">
            ...
            <div class="absolute -bottom-4 -right-4 w-16 h-16 bg-emerald-50 rounded-full opacity-40 group-hover:scale-125 transition-transform duration-500"></div>
        </div>

        {{-- Pembayaran Berhasil --}}
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 flex flex-col gap-3 group hover:shadow-md transition-all duration-300 relative overflow-hidden">
            <div class="w-10 h-10 bg-teal-50 rounded-xl flex items-center justify-center text-teal-600 group-hover:bg-teal-600 group-hover:text-white transition-colors duration-300">
            ...
            <div class="absolute -bottom-4 -right-4 w-16 h-16 bg-teal-50 rounded-full opacity-40 group-hover:scale-125 transition-transform duration-500"></div>
        </div>

        {{-- Pembayaran Pending --}}
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 flex flex-col gap-3 group hover:shadow-md transition-all duration-300 relative overflow-hidden">
            <div class="w-10 h-10 bg-amber-50 rounded-xl flex items-center justify-center text-amber-600 group-hover:bg-amber-500 group-hover:text-white transition-colors duration-300">
            ...
            <div class="absolute -bottom-4 -right-4 w-16 h-16 bg-amber-50 rounded-full opacity-40 group-hover:scale-125 transition-transform duration-500"></div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 flex flex-col">
            ...
            <div class="mt-4 space-y-2">
                <div class="flex items-center justify-between text-sm">
                    <span class="flex items-center gap-2"><span class="w-2.5 h-2.5 rounded-full bg-slate-300 inline-block"></span>Belum Terdaftar</span>
                    <span class="font-semibold text-slate-700">{{ $levelCount['userLevelNone'] }}</span>
                </div>
                <div class="flex items-center justify-between text-sm">
                    <span class="flex items-center gap-2"><span class="w-2.5 h-2.5 rounded-full bg-emerald-500 inline-block"></span>Level A</span>
                    <span class="font-semibold text-slate-700">{{ $levelCount['A'] }}</span>
                </div>
                <div class="flex items-center justify-between text-sm">
                    <span class="flex items-center gap-2"><span class="w-2.5 h-2.5 rounded-full bg-blue-500 inline-block"></span>Level B</span>
                    <span class="font-semibold text-slate-700">{{ $levelCount['B'] }}</span>
                </div>
                <div class="flex items-center justify-between text-sm">
                    <span class="flex items-center gap-2"><span class="w-2.5 h-2.5 rounded-full bg-purple-500 inline-block"></span>Level C</span>
            ...
            <div class="mb-4">
                ...
                <div class="h-2.5 bg-slate-100 rounded-full overflow-hidden">
                    ...
                    <div class="h-full bg-emerald-500 rounded-full transition-all duration-700"
                        style="width: {{ $maxCompleted > 0 ? round(($completedCount['A'] / $maxCompleted) * 100) : 0 }}%"></div>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="h-2.5 bg-slate-100 rounded-full overflow-hidden">
                    <div class="h-full bg-blue-500 rounded-full transition-all duration-700"
                        style="width: {{ $maxCompleted > 0 ? round(($completedCount['B'] / $maxCompleted) * 100) : 0 }}%"></div>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="h-2.5 bg-slate-100 rounded-full overflow-hidden">
                    <div class="h-full bg-purple-500 rounded-full transition-all duration-700"
                        style="width: {{ $maxCompleted > 0 ? round(($completedCount['C'] / $maxCompleted) * 100) : 0 }}%"></div>
                </div>
            </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
            ...
            <a href="{{ route('admin.asesi.index') }}" class="text-xs text-blue-600 hover:underline font-medium">Lihat semua →</a>
        </div>
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse ($recentPayments as $payment)
                        <tr class="hover:bg-slate-50/60 transition-colors">
                            ...
                            <td class="px-6 py-3 text-slate-600">{{ $payment->level?->name ?? 'Level ' . ($payment->level_id ?? '-') }}</td>
                            <td class="px-6 py-3 font-semibold text-slate-800">Rp {{ number_format($payment->amount, 0, ',', '.') }}</td>
                            <td class="px-6 py-3">
                                ...
                                @else
                                    <span class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-semibold bg-red-100 text-red-700">
                                        <span class="w-1.5 h-1.5 rounded-full bg-red-500"></span> {{ ucfirst($payment->status) }}
                                    </span>
                                @endif
                            </td>
...
<script>
    ...
    function renderChart(type) {
        ...
        chartInstance = new Chart(ctx, {
            ...
            options: {
                ...
                scales: type === 'bar' ? {
                    y: { beginAtZero: true, ticks: { color: '#94A3B8', font: { size: 11} }, grid: { color: '#F1F5F9', drawBorder: false } },
                    x: { ticks: { color: '#94A3B8', font: { size: 11} }, grid: { display: false, drawBorder: false } }
                } : {}
            }
        });
    ...
    function changeChartType(type) { renderChart(type); }
