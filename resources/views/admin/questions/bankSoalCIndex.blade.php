    ...
    <div class="p-4 bg-white rounded-lg mb-2">
        <nav class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mt-4 text-base">
            ...
            <ol class="flex items-center space-x-1 text-indigo-600">
                <li><a href="{{ route('admin.level.c.index') }}"
                        class="hover:underline {{ request()->routeIs('admin.level.c.*') ? 'text-indigo-600' : '' }}">Level C</a>
                </li>
                <li>/</li>
                <li><a href="{{ route('admin.categories.c.index') }}"
                        class="hover:underline {{ request()->routeIs('admin.categories.c.*') ? 'text-indigo-600' : '' }}">Kategory Soal</a>
                </li>
            </ol>
            ...
            <div class="flex flex-wrap items-center gap-3">
                <!-- Search -->
                <form action="{{ route('admin.question.c.index') }}" method="GET"
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ route('admin.question.c.create') }}" data-popover-target="popover-addUser"
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse ($questions as $index)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                                {{ $index->categoryC->name ?? 'N/A' }}
                            </td>

                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                                {!! Str::limit($index->question, 100) !!}
                            </td>
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                                <div class="flex space-x-2">
                                    <!-- View -->
                                    <a href="{{ route('admin.question.c.show', $index->id) }}"
                                    ...
                                    <!-- Edit -->
                                    <a href="{{ route('admin.question.c.edit', $index->id) }}"
                                    ...
                                    <!-- Delete -->
                                    <form action="{{ route('admin.question.c.destroy', $index->id) }}" method="POST"
            ...
            <div class="relative bg-white rounded-lg shadow-lg">
                ...
                <div class="p-6 text-center">
                    ...
                    <div class="flex justify-center space-x-3">
                        ...
                        <button data-modal-hide="popup-modal" type="button"
                            class="text-gray-700 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 border border-gray-300 rounded-lg text-sm font-medium px-5 py-2.5 focus:z-10 transition-colors">
                            Cancel
                        </button>
                    </div>
                </div>
