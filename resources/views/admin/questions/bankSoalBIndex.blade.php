    ...
    <div class="p-4 bg-white rounded-lg mb-2">
        <nav class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mt-4 text-base">
            ...
            <ol class="flex items-center space-x-1 text-indigo-600">
                <li><a href="{{ route('admin.level.b.index') }}"
                        class="hover:underline {{ request()->routeIs('admin.level.b.*') ? 'text-indigo-600' : '' }}">Level B</a>
                </li>
                <li>/</li>
                <li><a href="{{ route('admin.categories.b.index') }}"
                        class="hover:underline {{ request()->routeIs('admin.categories.b.*') ? 'text-indigo-600' : '' }}">Kategory Soal</a>
                </li>
            </ol>
            ...
            <div class="flex flex-wrap items-center gap-3">
                <!-- Search -->
                <form action="{{ route('admin.question.b.index') }}" method="GET"
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ route('admin.question.b.create') }}" data-popover-target="popover-addUser"
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                                <div class="flex space-x-2">
                                    <!-- View -->
                                    <a href="{{ route('admin.question.b.show', $index->id) }}"
                                    ...
                                    <!-- Edit -->
                                    <a href="{{ route('admin.question.b.edit', $index->id) }}"
                                    ...
                                    <!-- Delete -->
                                    <form action="{{ route('admin.question.b.destroy', $index->id) }}" method="POST"
