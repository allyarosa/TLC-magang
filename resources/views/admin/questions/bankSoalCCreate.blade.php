...
@section('content')
    <div class="max-w-5xl mx-auto px-4 pt-6 mt-4">
        ...
        <div
            ...
            <h1 class="text-xl font-bold text-white sm:text-2xl">Create Soal Level C</h1>
        </div>
        ...
        <div class="bg-white border border-gray-100 rounded-xl shadow-md overflow-hidden">
            ...
            <!-- Form body -->
            <div class="p-2">
                <form action="{{ route('admin.question.c.store') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                                ...
                                <div>
                                    <div class="mb-4">
                                        ...
                                        <textarea name="question" id="editor" rows="5"
                                            class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">{{ old('question') }}</textarea>
                                    </div>
