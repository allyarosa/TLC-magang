...
@section('content')
    <div class="max-w-5xl mx-auto px-4 pt-6 mt-4">
        ...
        <div
            ...
            <a href="{{ route('admin.categories.b.index') }}"
            ...
            <h1 class="text-xl font-bold text-white sm:text-2xl">Edit Kategori Level B</h1>
        </div>
        ...
        <div class="bg-white border border-gray-100 rounded-xl shadow-md overflow-hidden">
            ...
            <!-- Form body -->
            <div class="p-2">
                <form action="{{ route('admin.categories.b.update', $category->id) }}" enctype="multipart/form-data"
                    method="POST" class="">
                    @csrf
                    @method('put')
