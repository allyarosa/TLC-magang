    ...
    <div class="p-4 bg-white rounded-lg mb-2">
        <nav class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mt-4 text-base">
            ...
            <ol class="flex items-center space-x-1 text-gray-600">
                <li><a href="{{ route('admin.level.b.index') }}" class="hover:underline text-indigo-600">Level B</a></li>
                <li>/</li>
                <li><a href="{{ route('admin.categories.b.index') }}" class="hover:underline text-indigo-600">Kategory Soal</a></li>
            </ol>
        </nav>
    </div>
    <!-- User Table -->
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-sm text-gray-500">
                                <div class="flex space-x-2">
                                    <!-- Edit -->
                                    <a href="{{ route('admin.categories.b.edit', $index['id']) }}"
                                    ...
                                    <!-- View -->
                                    <a href="{{ route('admin.categories.b.show', $index['id']) }}"
