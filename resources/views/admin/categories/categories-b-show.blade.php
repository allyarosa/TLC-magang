...
@section('content')
    <div class="max-w-5xl mx-auto px-4 pt-6 mt-4">
        ...
        <div
            ...
            <h1 class="text-xl font-bold text-white sm:text-2xl">Detail Kategori Level B</h1>
        </div>
        ...
        <div class="bg-white border border-gray-100 rounded-xl shadow-md overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="bg-gray-50 p-6 rounded-lg shadow-inner mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-800">{{ $category->status ? 'Active' : 'Inactive' }}</p>
                        </div>
                                    ...
                                    @foreach($questions as $index => $question)
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-4 py-3 text-sm text-gray-500">
                                                {{ \Illuminate\Support\Str::limit($question->question_text, 70) }}
                                            </td>
                                            <td class="px-4 py-3 text-sm text-gray-500">
                ...
                <div class="mt-8 flex flex-col sm:flex-row justify-center gap-4">
                    <a href="{{ route('admin.categories.b.edit', $category->id) }}"
