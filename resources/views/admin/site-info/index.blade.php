...
@section('content')
    <div class="max-w-6xl mx-auto px-4 pt-6 mt-4">
        ...
        <div class="flex items-center justify-between p-4 mb-6 bg-gradient-to-r from-indigo-600 to-blue-600 rounded-xl shadow-lg">
            <a href="#"
        ...
        <div class="bg-white border border-gray-100 rounded-xl shadow-md overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-white p-3 border-b border-gray-100">
                ...
                <p class="mt-1 text-sm text-gray-500">Kelola informasi kontak dan media sosial yang ditampilkan di footer website</p>
            </div>
            ...
            <div class="p-3">
                <form action="#" method="POST" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                                    ...
                                    <input type="text" name="whatsapp" id="whatsapp"
                                        ...
                                        class="shadow-sm bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5">
                                    <p class="text-xs text-gray-500 mt-1">Format: +62 atau 08xx</p>
                                ...
                                <!-- Telegram -->
                                <div class="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                                    <label for="telegram" class="block mb-2 text-sm font-medium text-gray-700">
                                        <span class="flex items-center">
                                    ...
                                    <input type="url" name="telegram" id="telegram"
                                        value="{{ old('telegram', $footer->telegram ?? '') }}"
                                    ...
                                    <x-input-error :messages="$errors->get('telegram')" class="mt-1 text-xs" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
                        ...
                        <button type="submit"
                            class="px-6 py-3 text-base font-medium text-white bg-gradient-to-r from-indigo-600 to-blue-600 rounded-lg hover:from-indigo-700 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-all duration-200 flex items-center shadow-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M5 13l4 4L19 7" />
        ...
        <div class="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-6">
            <div class="flex items-start">
                ...
                <div>
                    <h4 class="text-sm font-semibold text-blue-900 mb-2">Tips Pengisian</h4>
                    <ul class="text-sm text-blue-800 space-y-1">
                        <li>• Pastikan semua link media sosial menggunakan URL lengkap (https://)</li>
                        <li>• Nomor WhatsApp dapat menggunakan format +62 atau 08xx</li>
                        <li>• Deskripsi singkat sebaiknya tidak lebih dari 200 karakter untuk tampilan optimal</li>
                        <li>• Copyright text akan muncul di bagian paling bawah footer website</li>
                        <li>• Semua field bersifat opsional, Anda bisa mengisi sesuai kebutuhan</li>
                    </ul>
                </div>
            </div>
        </div>
