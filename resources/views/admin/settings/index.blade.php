                    ...
                    <div class="flex flex-col items-center text-center gap-4">
                        <div class="relative">
                            <img class="rounded-full w-28 h-28 object-cover ring-4 ring-slate-100"
                                ...
                                alt="Foto Profil">
                            <span class="absolute -bottom-1 -right-1 w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center shadow-md">
                        ...
                        <div class="flex w-full gap-2">
                            ...
                            <button class="flex-1 px-3 py-2 text-xs font-medium text-white bg-blue-600 rounded-lg flex items-center justify-center gap-1.5 transition-colors hover:bg-blue-700"
                ...
                <div class="p-6">
                    <form action="{{ route('admin.password.update') }}" method="post">
                        ...
                        <div class="space-y-5">
                            {{-- Current Password --}}
                            <div>
                                <label for="update_password_current_password" class="block mb-1.5 text-xs font-medium text-slate-600">
                                    Kata Sandi Saat Ini
                                </label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-slate-400">
                                    ...
                                    <button type="button" onclick="toggleVisibility('update_password_current_password', 'icon-cp')"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                {{-- New Password --}}
                                <div>
                                    <label for="update_password_password" class="block mb-1.5 text-xs font-medium text-slate-600">
                                        Password Baru
                                    </label>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-slate-400">
                                        ...
                                        <button type="button" onclick="toggleVisibility('update_password_password', 'icon-np')"
                                            class="absolute inset-y-0 right-0 flex items-center pr-3 text-slate-400 hover:text-slate-600">
                                ...
                                {{-- Confirm Password --}}
                                <div>
                                    <label for="update_password_password_confirmation" class="block mb-1.5 text-xs font-medium text-slate-600">
                                        Konfirmasi Password
                                    </label>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-slate-400">
                                        ...
                                        <button type="button" onclick="toggleVisibility('update_password_password_confirmation', 'icon-conf')"
                                            class="absolute inset-y-0 right-0 flex items-center pr-3 text-slate-400 hover:text-slate-600">
                        ...
                        <div class="mt-4 flex items-start gap-2 bg-amber-50 border border-amber-100 rounded-lg px-3 py-2.5">
                            <i class="fas fa-lightbulb text-amber-400 text-xs mt-0.5"></i>
                            <p class="text-xs text-amber-700">Gunakan minimal 8 karakter dengan kombinasi huruf besar, huruf kecil, angka, dan simbol.</p>
                        </div>
    ...
    <div class="relative bg-white rounded-2xl shadow-xl p-6 w-11/12 md:w-2/5 max-h-[90vh] overflow-y-auto">
        ...
        <div class="flex flex-col items-center gap-4">
            <img id="profileImage"
                src="{{ asset('storage/' . auth()->user()->adminsProfile->profile_image) }}"
                alt="Foto Profil"
                class="rounded-xl w-full max-h-80 object-cover">
        ...
        <div class="relative bg-white rounded-2xl shadow-xl">
            ...
            <div class="p-5">
                <form class="space-y-4" action="#" method="post" enctype="multipart/form-data">
                    @csrf
                    <div>
                        <label for="profile_image" class="block text-xs font-medium text-slate-600 mb-2">Pilih Foto</label>
