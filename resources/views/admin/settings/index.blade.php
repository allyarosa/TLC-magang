    ...
    <div class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div class="mb-6">
            <a href="{{ url()->previous() }}" class="flex items-center text-blue-600 hover:text-blue-800 transition-colors">
                ...
                <span class="text-xl font-semibold">Pengaturan Admin</span>
            </a>
        </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 mb-6 transition-all hover:shadow-md">
                    <div class="p-6">
                        ...
                        <div class="flex flex-col sm:flex-row items-center gap-6">
                            <div class="relative">
                                <img class="rounded-full w-32 h-32 object-cover border-4 border-gray-100" src="{{ optional($user->adminProfile)->photo ? asset('storage/' . $user->adminProfile->photo) : asset('images/default-avatar.png') }}" alt="Foto Profil">
