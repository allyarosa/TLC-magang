<section id="visimisi" class="w-full bg-white text-gray-900">

    {{-- Header Banner --}}
    <div class="w-full py-14 px-5" style="background: linear-gradient(135deg, #0d1b5e 0%, #1D4E89 60%, #2A6BAD 100%);">
        <div class="max-w-3xl mx-auto text-center">
            <h2 class="text-2xl md:text-3xl font-bold text-white mb-3 tracking-tight">
                Transformasi Pendidikan Dimulai dari Anda
            </h2>
            <p class="text-white/70 text-sm md:text-base leading-relaxed max-w-2xl mx-auto">
    ...
    {{-- Cards --}}
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-8 px-4 md:px-6 -mt-6 pb-10">
