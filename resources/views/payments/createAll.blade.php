                    ...
                    <div class="flex flex-col md:flex-row items-center">
                        <div class="flex-1 mb-6 md:mb-0 md:pr-8">
                            ...
                            <h1 class="text-2xl md:text-3xl font-bold mb-4 leading-tight">
                                Level A B C Teaching Activation Certification
                            </h1>
            ...
            <div class="bg-white rounded-3xl p-8 shadow-lg hover-lift">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-600 leading-relaxed text-lg">
                        Program Bundling Sertifikasi Level A, B, dan C dirancang untuk menguji sekaligus mengembangkan kompetensi profesional guru secara menyeluruh. Melalui program ini, guru akan melewati tiga tahapan terintegrasi:

                        Level A berfokus pada pemahaman mendalam terhadap konsep dasar pedagogik dan konten pembelajaran.
                        Level B menekankan pada aktivasi pengetahuan PCK (Pedagogical Content Knowledge) dan HOTS (Higher Order Thinking Skills) dalam praktik pengajaran, serta pengembangan Modul Ajar (Lesson Plan), Teaching Tactics, dan Teaching Scenario.
                        Level C memperluas kemampuan guru dalam melakukan refleksi kritis, evaluasi pembelajaran, serta inovasi strategi pengajaran berbasis data.
                    </p>
                </div>
