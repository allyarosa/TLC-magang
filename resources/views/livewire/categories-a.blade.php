<div>
    ...
    @if ($activeCategoryId)
        <div class="fixed inset-0 z-[100] flex items-center justify-center bg-gray-900/60 backdrop-blur-sm p-4 sm:p-6 opacity-100 transition-opacity">
            <div class="bg-white max-w-3xl w-full rounded-[24px] shadow-2xl relative flex flex-col transform transition-all max-h-full">
                <!-- Header -->
                <div class="p-6 md:px-8 md:py-6 border-b border-gray-100 bg-white rounded-t-[24px] flex-shrink-0 relative overflow-hidden">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center gap-4 mt-2 sm:mt-0">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 font-medium mt-1">Teaching & Learning Certification (TLC)</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 md:p-8 overflow-y-auto">
                    <div class="bg-blue-50/50 rounded-2xl p-5 mb-8 border border-blue-100">
                        <p class="text-gray-700 leading-relaxed text-[15px]">
                            Selamat datang di tahap awal sertifikasi TLC. Pada level ini, Anda akan mengikuti tes teori untuk mengukur kompetensi dasar mengajar yang efektif berdasarkan pendekatan <strong>Teaching Mastery Framework (TMF)</strong>.
                        </p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <!-- PCK -->
                        <div class="bg-white p-5 rounded-2xl border border-gray-100 hover:border-blue-300 hover:shadow-lg hover:shadow-blue-500/10 transition-all group relative overflow-hidden">
                            <div class="absolute -top-10 -right-10 w-24 h-24 bg-blue-50 rounded-full z-0 group-hover:bg-blue-100 transition-colors"></div>
                            <div class="relative z-10 flex items-start gap-4">
                                <div class="bg-blue-100 text-blue-600 w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0">
                        ...
                        <!-- HOTS -->
                        <div class="bg-white p-5 rounded-2xl border border-gray-100 hover:border-purple-300 hover:shadow-lg hover:shadow-purple-500/10 transition-all group relative overflow-hidden">
                             <div class="absolute -top-10 -right-10 w-24 h-24 bg-purple-50 rounded-full z-0 group-hover:bg-purple-100 transition-colors"></div>
                            <div class="relative z-10 flex items-start gap-4">
                                <div class="bg-purple-100 text-purple-600 w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0">
                        ...
                        <!-- Literasi -->
                        <div class="bg-white p-5 rounded-2xl border border-gray-100 hover:border-green-300 hover:shadow-lg hover:shadow-green-500/10 transition-all group relative overflow-hidden">
                             <div class="absolute -top-10 -right-10 w-24 h-24 bg-green-50 rounded-full z-0 group-hover:bg-green-100 transition-colors"></div>
                            <div class="relative z-10 flex items-start gap-4">
                                <div class="bg-green-100 text-green-600 w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0">
                        ...
                        <!-- Numerasi -->
                        <div class="bg-white p-5 rounded-2xl border border-gray-100 hover:border-amber-300 hover:shadow-lg hover:shadow-amber-500/10 transition-all group relative overflow-hidden">
                             <div class="absolute -top-10 -right-10 w-24 h-24 bg-amber-50 rounded-full z-0 group-hover:bg-amber-100 transition-colors"></div>
                            <div class="relative z-10 flex items-start gap-4">
                                <div class="bg-amber-100 text-amber-600 w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div class="p-4 md:px-8 md:py-5 border-t border-gray-100 bg-gray-50 rounded-b-[24px] flex-shrink-0">
                    <div class="flex flex-col-reverse sm:flex-row gap-3 justify-end items-center">
                        <button wire:click="closeModal" type="button" class="w-full sm:w-auto px-6 py-2.5 text-gray-600 font-bold hover:bg-gray-200 rounded-xl transition-colors">
                            Batal
                        </button>
                        <form action="{{ route('asesi.sertifikasi.level.a.instruction') }}" method="post" class="w-full sm:w-auto m-0">
