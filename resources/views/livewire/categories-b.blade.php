                ...
                <div class="flex justify-between items-center">
                    ...
                    @if ($user->hasPermissionTo('MODUL_AJAR'))
                        @if ($user->hasPermissionTo('MODUL_AJAR_COMPLETED'))
                            <a wire:navigate href="{{ route('asesi.sertifikat.b', Vinkla\Hashids\Facades\Hashids::encode(Auth::id())) }}" class="flex-1 font-medium py-3 px-1.5 rounded-xl transform transition duration-300 focus:outline-none bg-yellow-500 hover:bg-yellow-400 text-white cursor-pointer text-center block">
