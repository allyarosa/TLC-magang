        ...
        <div class="bg-white rounded-lg shadow-sm p-4 sm:p-6 lg:p-8">
            ...
            <div class="bg-gradient-to-r from-[#1D4E89] to-[#2A5AAF] p-4 sm:p-6 rounded-xl mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between shadow-lg border gap-4">
                ...
                <div class="flex gap-3">
                    ...
                    <a wire:navigate href="{{ route('asesi.sertifikat.b', Vinkla\Hashids\Facades\Hashids::encode(Auth::id())) }}" class="flex-1 font-medium py-3 px-1.5 rounded-xl transform transition duration-300 focus:outline-none focus:ring-4 focus:ring-blue-300 bg-gradient-to-r from-[#1D4E89] to-[#2A5AAF] hover:from-[#14406B] hover:to-[#1F4A92] text-white cursor-pointer text-center block">
