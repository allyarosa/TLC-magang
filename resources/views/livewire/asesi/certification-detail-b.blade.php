...
<div id="detail_sertifikasi_page" class="page-section py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center mb-4">
            ...
            <a wire:navigate href="{{ route('asesi.sertifikasi') }}"
                class="mt-5 flex items-center text-blue-600 hover:text-blue-800 transition duration-200">
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 sm:p-6 lg:p-8">
            <h1 class="text-base sm:text-lg lg:text-2xl font-bold text-gray-800 mb-6">Progres Teaching Mastery
                Certification Level B</h1>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-base sm:text-lg font-bold text-white mb-1">Teaching Mastery Certification Level B
                        </p>
                ...
                <div class="flex gap-3">
                    @if ($hasAccessB)
                        @if (Auth::user()->hasPermissionTo('level_B_completed'))
                            <a wire:navigate
                                href="{{ route('asesi.sertifikat.b', Vinkla\Hashids\Facades\Hashids::encode(Auth::id())) }}"
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-8">
                            ...
                            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 rounded-lg">
                                <table class="min-w-full divide-y divide-gray-300">
                                    <thead class="bg-yellow-300">
                                        <tr>
                                            <th
                                                class="px-3 py-3 text-left text-md font-bold text-gray-700 uppercase tracking-wider">
                                                Tugas</th>
                                            <th
                                                class="px-3 py-3 text-left text-md font-bold text-gray-700 uppercase tracking-wider">
                                                Terakhir</th>
                ...
                <div
                    class="bg-white rounded-lg shadow-lg p-4 sm:p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    <h2 class="text-base sm:text-lg lg:text-xl font-bold text-gray-800 mb-2">Riwayat Ujian Penilaian
                    </h2>
                    <div class="w-20 sm:w-24 h-1 bg-yellow-400 mb-6"></div>
                                    ...
                                    @forelse($history as $riwayat)
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <tr>
                                                ...
                                                <td class="px-3 py-4 text-md text-gray-700">
                                                    {{ strip_tags($riwayat->comment_asesor) }}</td>
                                            </tr>
                                        @empty
                                            <tr>
                                                <td colspan="3" class="text-center py-4">Belum ada data</td>
                ...
                <div
                    ...
                    <div class="bg-white rounded-t-xl p-6">
                        ...
                        <div class="text-right">
                            <a href="https://chat.whatsapp.com/GpICk4Co6H1Fv3kgnxhRJ5"
                                class="text-sm font-semibold text-[#1D4E89] hover:text-blue-800">
