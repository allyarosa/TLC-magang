        ...
        <div class="max-w-5xl mx-auto px-4 mb-12">
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-800 via-blue-800 to-blue-400 px-8 py-6">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-white/80 text-base">Level A</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-8 py-12">
                    ...
                    <div class="text-center mb-8">
                        <h3 class="text-5xl font-bold text-blue-700 mb-2">{{ $namaGelar }}</h3>
                        <p class="text-gray-600">Terimakasih atas pencapaian dalam menyelesaikan sertifikasi</p>
                    </div>
            ...
            <div class="text-center mt-6">
                <a href="{{ route('asesi.downloadCertificate', Vinkla\Hashids\Facades\Hashids::encode($id)) }}"
                    class="bg-blue-700 hover:bg-blue- text-white px-8 py-3 rounded-lg font-semibold transition-colors">
                    Download Sertifikat
                </a>
            </div>

            <a href="{{ route('certificate.preview', Vinkla\Hashids\Facades\Hashids::encode($id)) }}" class="btn btn-primary" target="_blank">
                Preview Sertifikat
            </a>

            <a href="{{ route('certificate.preview.pdf', Vinkla\Hashids\Facades\Hashids::encode($id)) }}" class="btn btn-info" target="_blank">
                Preview PDF
            </a>

            <a href="{{ route('certificate.download', Vinkla\Hashids\Facades\Hashids::encode($id)) }}" class="btn btn-success">
                Download Sertifikat
            </a>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="flex items-start space-x-6 mb-8">
                        <img src="{{ asset('/images/svg/blankCategories.svg') }}" alt="Course thumbnail"
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
                        <p class="text-gray-700 mb-6">
                            ...
                            Teaching Mastery Framework serta Literasi Numerasi. Program ini dirancang untuk meningkatkan
                            kompetensi guru dalam menerapkan metode pembelajaran modern yang sesuai dengan standar
                            pendidikan nasional.
                        </p>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">Mengikuti penugasan yang telah disediakan melalui
                                        Learning Management System Elevate untuk mempersiapkan materi ujian.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">Mengikuti training sebanyak 12 kali pertemuan yang
                                        mencakup teori dan praktik pengajaran efektif, pembelajaran terstruktur, dan
                                        diferensiasi pembelajaran.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">Mengikuti ujian komprehensif yang meliputi: PCK
                                        (Pedagogical Content Knowledge), HOTS (Higher Order Thinking Skills), Numerasi, dan
                                        Literasi.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">Sertifikat resmi yang diakui secara nasional dengan
                                        nomor NPSN.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">Mendapatkan gelar pengakuan kompetensi dalam bidang
                                        pengajaran.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">Laporan detail hasil ujian untuk evaluasi kemampuan
                                        dan area yang perlu diperbaiki.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">Akses ke worksheet praktis dan modul pembelajaran
                                        digital yang dapat digunakan dalam kegiatan mengajar.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">Akses ke webinar dan diskusi eksklusif HAFECS untuk
                                        pengembangan profesional berkelanjutan.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">Koneksi dengan jaringan guru profesional untuk berbagi
                                        pengalaman dan best practices.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-8 p-4 bg-blue-50 rounded-lg">
                            ...
                            <p class="text-sm text-gray-600 mt-4">
                                Program sertifikasi ini dirancang untuk meningkatkan kualitas pendidikan melalui
                                pengembangan kompetensi guru yang berkelanjutan.
                            </p>
                        </div>
                    </div>
                </div>
