...
<<<<<<< HEAD
    <div
        ...
        <div class="bg-white rounded-xl shadow-lg dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
            <div class="p-4 sm:p-6 md:p-8">
                ...
                @if ($errors->any())
                    <div
                        class="mb-6 p-3 sm:p-4 bg-red-50 border border-red-200 text-red-700 dark:bg-red-900/20 dark:border-red-800 dark:text-red-300 rounded-lg">
                ...
                <form id="modulAjarForm" action="{{ route('asesi.sertifikasi.level.b.store') }}" method="POST"
                    enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    @method('post')

                    <div class="space-y-2">
                        <label for="modul_ajar"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const fileInput = document.getElementById('modul_ajar');
