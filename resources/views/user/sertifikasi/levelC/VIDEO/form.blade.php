...
<div class="w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-2xl xl:max-w-3xl mx-auto mt-6 sm:mt-8 md:mt-10 px-4 sm:px-6">
    <div class="bg-white rounded-xl shadow-lg dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
        <div class="p-4 sm:p-6 md:p-8">
            ...
            <form id="videoForm" action="{{ route('asesi.sertifikasi.level.c.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf

                <div class="space-y-2">
                    <label for="url_video" class="block text-sm sm:text-base font-semibold text-gray-700 dark:text-gray-200">
                        Link Video YouTube
                        <span class="text-red-500">*</span>
                    </label>
                    <input type="url" id="url_video" name="url_video" required value="" class="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:outline-none hover:border-gray-400 dark:hover:border-gray-500 transition-colors duration-200" placeholder="https://www.youtube.com/watch?v=...">
                ...
                <div class="space-y-2">
                    ...
                    <textarea id="description" name="description" rows="4" class="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:outline-none hover:border-gray-400 dark:hover:border-gray-500 transition-colors duration-200 resize-none" placeholder="Tuliskan deskripsi singkat tentang video pembelajaran Anda..."></textarea>
                    <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                ...
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4">
                    ...
                    <button type="submit" class="w-full sm:flex-1 px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:bg-indigo-700 rounded-lg shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-sm w-full mx-4 transform transition-all">
        <div class="p-6">
            ...
            <div class="flex gap-3">
                ...
                <button id="confirmBtn" type="button" class="flex-1 px-4 py-2 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors">
                    Ya, Upload
                </button>
            </div>
        </div>
