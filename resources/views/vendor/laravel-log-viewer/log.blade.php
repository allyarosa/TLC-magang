  ...
  <div class="row">
    <div class="col sidebar mb-3">
      <div class="d-flex align-items-center justify-content-between mb-1">
        <h1 class="mb-0"><i class="fa fa-calendar" aria-hidden="true"></i> Laravel Log Viewer</h1>
        <a href="{{ route('admin.dashboard') }}" class="btn btn-outline-secondary btn-back ml-3">
